...
def setup_transfer_learning(pretrained_model_path, dataset_yaml_path, project_name="heichole_transfer"):
    """
    ...
    training_args = {
        ...
        'imgsz': 512,              # Reduzierte Bildgröße
...
def main():
    # Pfade definieren
    PRETRAINED_MODEL = "/home/Bartscht/YOLO/surgical-instrument-action-detection/domain_adaptation/hei_chole/experiments/heichole_transfer_2/transfer_learning/weights/epoch30.pt"
    ...
    try:
        results = setup_transfer_learning(
            PRETRAINED_MODEL,
            DATASET_YAML,
            project_name="heichole_transfer_2"
        )
