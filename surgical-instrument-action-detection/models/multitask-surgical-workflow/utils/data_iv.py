...
class T50(Dataset):
    ...
    def map_file(self):
        return np.array([
            [ 0,  0,  2,  1,  0,  1],  # grasper-dissect (0)
            [ 1,  0,  2,  0,  0,  1],
            [ 2,  0,  2, 10,  0,  1],
            [ 3,  0,  0,  3,  1,  2],  # grasper-grasp (1)
            [ 4,  0,  0,  2,  1,  2],
            [ 5,  0,  0,  4,  1,  2],
            [ 6,  0,  0,  1,  1,  2],
            [ 7,  0,  0,  0,  1,  2],
            ...
            [11,  0,  0, 11,  1,  2],
            [12,  0,  0, 13,  1,  2],
            [13,  0,  8,  0,  2,  0],  # grasper-pack (2)
            [14,  0,  1,  2,  3,  2],  # grasper-retract (3)
            [15,  0,  1,  4,  3,  4],
            [16,  0,  1,  1,  3,  1],
            [17,  0,  1,  0,  3,  0],
            [18,  0,  1, 12,  3, 12],
            ...
            [20,  0,  1, 10,  3, 10],
            [21,  0,  1, 11,  3, 11],
            [22,  1,  3,  7,  4, 22],  # bipolar-coagulate (4)
            [23,  1,  3,  5,  4, 20],
            [24,  1,  3,  3,  4, 18],
            [25,  1,  3,  2,  4, 17],
            [26,  1,  3,  4,  4, 19],
            ...
            [30,  1,  3, 10,  4, 25],
            [31,  1,  3, 11,  4, 26],
            [32,  1,  2,  9,  5, 24],  # bipolar-dissect (5)
            [33,  1,  2,  3,  5, 18],
            [34,  1,  2,  2,  5, 17],
            [35,  1,  2,  1,  5, 16],
            [36,  1,  2,  0,  5, 15],
            [37,  1,  2, 10,  5, 25],
            [38,  1,  0,  1,  6, 16],  # bipolar-grasp (6)
            [39,  1,  0,  8,  6, 23],
            [40,  1,  0, 13,  6, 28],
            [41,  1,  1,  2,  7, 17],  # bipolar-retract (7)
            [42,  1,  1,  4,  7, 19],
            [43,  1,  1,  0,  7, 15],
            [44,  1,  1,  8,  7, 23],
            [45,  1,  1, 10,  7, 25],
            [46,  2,  3,  5,  8, 35],  # hook-coagulate (8)
            [47,  2,  3,  3,  8, 33],
            [48,  2,  3,  2,  8, 32],
            [49,  2,  3,  4,  8, 34],
            [50,  2,  3,  1,  8, 31],
            ...
            [52,  2,  3,  8,  8, 38],
            [53,  2,  3, 10,  8, 40],
            [54,  2,  5,  5,  9, 35],  # hook-cut (9)
            [55,  2,  5, 11,  9, 41],
            [56,  2,  2,  5, 10, 35],  # hook-dissect (10)
            [57,  2,  2,  3, 10, 33],
            [58,  2,  2,  2, 10, 32],
            [59,  2,  2,  1, 10, 31],
            [60,  2,  2,  0, 10, 30],
            [61,  2,  2, 10, 10, 40],
            [62,  2,  2, 11, 10, 41],
            [63,  2,  1,  0, 11, 30],  # hook-retract (11)
            [64,  2,  1,  8, 11, 38],
            [65,  3,  3, 10, 12, 55],  # scissors-coagulate (12)
            [66,  3,  5,  9, 13, 54],  # scissors-cut (13)
            [67,  3,  5,  5, 13, 50],
            [68,  3,  5,  3, 13, 48],
            [69,  3,  5,  2, 13, 47],
            [70,  3,  5,  1, 13, 46],
            ...
            [72,  3,  5, 10, 13, 55],
            [73,  3,  5, 11, 13, 56],
            [74,  3,  2,  1, 14, 46],  # scissors-dissect (14)
            [75,  3,  2,  0, 14, 45],
            [76,  3,  2, 10, 14, 55],
            [77,  4,  4,  5, 15, 65],  # clipper-clip (15)
            [78,  4,  4,  3, 15, 63],
            [79,  4,  4,  2, 15, 62],
            [80,  4,  4,  4, 15, 64],
            [81,  4,  4,  1, 15, 61],
            [82,  5,  6,  6, 16, 81],  # irrigator-aspirate (16)
            [83,  5,  2,  2, 17, 77],  # irrigator-dissect (17)
            [84,  5,  2,  4, 17, 79],
            [85,  5,  2,  1, 17, 76],
            [86,  5,  2,  0, 17, 75],
            [87,  5,  2, 10, 17, 85],
            [88,  5,  7,  7, 18, 82],  # irrigator-irrigate (18)
            [89,  5,  7,  4, 18, 79],
            [90,  5,  7,  8, 18, 83],
            [91,  5,  1,  0, 19, 75],  # irrigator-retract (19)
            [92,  5,  1,  8, 19, 83],
            [93,  5,  1, 10, 19, 85],
            [94,  0,  9, 14, 20, 14],  # grasper-null_verb (20)
            [95,  1,  9, 14, 21, 29],  # bipolar-null_verb (21)
            [96,  2,  9, 14, 22, 44],  # hook-null_verb (22)
            [97,  3,  9, 14, 23, 59],  # scissors-null_verb (23)
            [98,  4,  9, 14, 24, 74],  # clipper-null_verb (24)
            [99,  5,  9, 14, 25, 89]   # irrigator-null_verb (25)
            ])
    
    def get_binary_labels(self, labels):
        iv_label = np.zeros(26)  # 26 mögliche IV-Paare (0-25)
