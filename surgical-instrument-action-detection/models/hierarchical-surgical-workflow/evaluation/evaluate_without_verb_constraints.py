...
class ModelLoader:
    ...
    def setup_paths(self):
        ...
        self.verb_model_path = self.hierarchical_dir / "verb_recognition/checkpoints/graceful-firebrand-50/last.ckpt"
        # Dataset path
    ...
    def load_verb_model(self):
        try:
            model = UnconstrainedSurgicalVerbRecognition.load_from_checkpoint(
